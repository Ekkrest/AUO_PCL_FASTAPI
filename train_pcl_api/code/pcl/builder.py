...
class MoCo(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, r=16384, m=0.999, T=0.1, mlp=False):
        ...
        self.encoder_q = base_encoder(block=Res2netFFM.Bottle2neck, layers=[3, 4, 6, 3], num_classes=dim)
        self.encoder_k = base_encoder(block=Res2netFFM.Bottle2neck, layers=[3, 4, 6, 3], num_classes=dim)
